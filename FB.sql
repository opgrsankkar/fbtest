...
CREATE TABLE SHOUT(SHOUT_ID NUMERIC PRIMARY KEY AUTO_INCREMENT,
	USER_ID NUMERIC ,
	CONTENT VARCHAR(25),
	DATES DATE,FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID));

CREATE TABLE ATTENDS(USER_ID NUMERIC PRIMARY KEY ,
...
CREATE TABLE PHOTO_LIKE (USER_ID NUMERIC PRIMARY KEY ,
...
CREATE TABLE POST_LIKE (USER_ID NUMERIC PRIMAR KEY ,
...
CREATE TABLE PHOTO_TAG(USER_ID NUMERIC PRIMARY KEY ,
	PHOTO_ID NUMERIC PRIMARY KEY,FOREIGN KEY (PHOTO_ID)REFERENCES PHOTO(PHOTO_ID),FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID));

CREATE TABLE POST_TAG(USER_ID NUMERIC PRIMARY KEY ,
	POST_ID NUMERIC PRIMARY KEY REFERENCES POST,FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID));

CREATE TABLE FRIENDS(USER_ID1 NUMERIC PRIMARY KEY ,
	USER_ID2 NUMERIC PRIMARY KEY ,
	REQUEST_DATE DATE,
