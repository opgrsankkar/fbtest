...
CREATE TABLE PHOTOS(PHOTO_ID INTEGER PRIMARY KEY AUTO_INCREMENT,
	POST_ID INTEGER,
	USER_ID INTEGER,
	DATE DATE,
	PHOTO LONGBLOB,
...
CREATE TABLE CONTAINS(PHOTO_ID INTEGER PRIMARY KEY,
	POST_ID INTEGER,FOREIGN KEY(POST_ID) REFERENCES POST(POST_ID),FOREIGN KEY(PHOTO_ID) REFERENCES PHOTOS(PHOTO_ID));
...
CREATE TABLE PHOTO_TAG(USER_ID INTEGER PRIMARY KEY ,
	PHOTO_ID INTEGER PRIMARY KEY,FOREIGN KEY (PHOTO_ID)REFERENCES PHOTOS(PHOTO_ID),FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID));
