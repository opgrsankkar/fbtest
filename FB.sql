...
CREATE FUNCTION CHECK_FRIEND(IN REQ_ID NUMERIC(20), IN ACC_ID NUMERIC(20)) RETURNS INTEGER DETERMINISTIC				 
BEGIN	
	DECLARE C CURSOR FOR SELECT USER_ID1,USER_ID2 FROM FRIENDS;
	DECLARE CONTINUE HANDLER FOR NOT FOUND SET DONE = TRUE;
	DECLARE D C%ROWTYPE;DECLARE E C%ROWTYPE;
	OPEN C;
	FETCH C INTO D,E;
		IF DONE THEN
			CASE 
				WHEN C%NOTFOUND  THEN RETURN 0;
				WHEN D%ISFOUND and E%NOTFOUND  THEN RETURN 1;
				WHEN C%ISFOUND	THEN RETURN 2;
			END CASE;
		END IF;
	CLOSE C;
END;	
